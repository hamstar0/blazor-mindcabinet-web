...
// termSetsData.CreateForSimplePost_Async
        var fillerPosts = new List<(object postData, long[] postTags)>();
        fillerPosts.Append( (
            postData: new {
            ...
            postTags: new long[] { sampleTerm.TermRaw.Id, term1.TermRaw.Id, term3.TermRaw.Id }
        ) );
        fillerPosts.Append( (
            postData: new {
            ...
            postTags: new long[] { sampleTerm.TermRaw.Id, term1.TermRaw.Id }
        ) );
        fillerPosts.Append( (
            postData: new {
        ...
        fillerPosts.Append( (
            ...
            postTags: new long[] { sampleTerm.TermRaw.Id, term2.TermRaw.Id }
        ) );
        fillerPosts.Append( (
            postData: new {
        ...
        fillerPosts.Append( (
            ...
            postTags: new long[] { sampleTerm.TermRaw.Id, term2.TermRaw.Id, term3.TermRaw.Id }
        ) );
        fillerPosts.Append( (
            postData: new {
        ...
        foreach( var (postData, postTags) in fillerPosts ) {
            ...
            await termSetsData.CreateForSimplePost_Async( dbConnection, newPostId, postTags );
        }
